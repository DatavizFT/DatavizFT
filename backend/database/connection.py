...
class DatabaseConnection:
    ...
    async def create_indexes(self):
        ...
        await db.offres.create_index([
            ("source_id", 1)  # Unique ID source
        ], unique=True, name="idx_source_id")
        ...
        ], name="idx_geo_coords", sparse=True)
        
        # Index pour collection stats_competences
        await db.stats_competences.create_index([
            ("competence", 1),
            ("periode", 1)
        ], unique=True, name="idx_competence_periode")
        
        await db.stats_competences.create_index([
            ("date_analyse", -1)
        ], name="idx_date_analyse")
        ...
        try:
            ...
            for coll_name in collections:
                ...
                info["collections"][coll_name] = {
                    ...
                    "size_mb": round(coll.estimated_document_count() * 0.001, 2)  # Estimation
                }
...
DATABASE_CONFIGS = {
    "development": {
        ...
        "database": "dataviz_ft_dev"
    },
    "test": {
        "url": "mongodb://localhost:27017", 
        "database": "dataviz_ft_test"
    },
    "production": {
