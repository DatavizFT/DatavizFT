...
OFFRE_SCHEMA = {
    ...
    "properties": {
        ...
        "entreprise_nom": {"bsonType": ["string", "null"], "maxLength": 100},
        "secteur_activite": {"bsonType": ["string", "null"], "maxLength": 100},
        "localisation": {
            "bsonType": "object",
        ...
        "type_contrat": {"bsonType": ["string", "null"], "maxLength": 50},
        "salaire_min": {
...
COMPETENCE_SCHEMA = {
    ...
    "properties": {
        ...
        "popularite": {"bsonType": ["number", "null"], "minimum": 0.0, "maximum": 1.0},
        "difficulte": {"bsonType": ["int", "null"], "minimum": 1, "maximum": 5},
        "tags": {"bsonType": "array", "items": {"bsonType": "string", "maxLength": 30}},
    },
}
...
STATS_SCHEMA = {
    ...
    "properties": {
        ...
        "nb_offres_analysees": {"bsonType": "int", "minimum": 0},
        "competences_stats": {
            "bsonType": "array",
            "items": {
                "bsonType": "object",
...
async def create_collection_with_schema(
    database: AsyncIOMotorDatabase, collection_name: str, schema: dict[str, Any]
) -> bool:
    """
