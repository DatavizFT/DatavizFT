...
class FranceTravailPipeline:
    ...
    async def get_pipeline_stats(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"pipeline_name": self.orchestrator.pipeline_name, "error": str(e)}
        finally:
            await self.orchestrator.close_database()
    ...
    async def executer_pipeline_complet(
        ...
        return {
            ...
            "statistiques_par_categorie": statistics.get(
    ...
    async def obtenir_statistiques_mongodb(self) -> dict[str, Any]:
        ...
        try:
            ...
            if not latest_stats:
                ...
                nb_offres_total = (
                    await self.orchestrator.offres_repo.collection.count_documents(
                ...
                "top_competences": [
                    {
                        ...
                        "occurrences": comp["nb_occurrences"],
                    }
